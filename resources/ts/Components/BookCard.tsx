    ...
    <Card className="flex h-[400px] w-full flex-col">
      ...
      <CardContent className="flex-grow">
        <div className="mb-2">
          ...
          <p className="inline text-xs text-gray-500">発売日: {publishDate}</p>
        </div>
        <Button size={'sm'} variant="outline" className="hover:text-red-500">
          <Heart strokeWidth={2} className="hover:text-red-500"></Heart>
          お気に入りに追加
        </Button>
