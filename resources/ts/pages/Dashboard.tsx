      ...
      <div className="space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between">
              <div className="md:w-3/4">
                <h3 className="mb-2 text-xl font-medium text-green-600">
                  📚 本棚の作成と管理
                </h3>
                <p className="text-gray-700">
        ...
        <section className="rounded-sm border border-green-600 bg-white p-6 shadow-md">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="mb-1 text-lg font-medium text-green-600">
                Q: 本の情報はどこから取得していますか？
              </h3>
              <p className="text-gray-700">
                A:
                楽天ブックスAPIから書籍情報を取得しています。検索結果から直接楽天市場ほかAmazonへのリンクも利用できます。
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                A:
                共有リンクの有効期限は7日間です。ただし、本棚を削除すると関連する共有リンクは無効になります。
              </p>
            </div>
            ...
            <div>
              ...
              <p className="flex items-center text-gray-700">
                A:
                画面右上のユーザーメニューから「プロフィール」を選択すると、アカウント情報の変更ができます。
                <Link
