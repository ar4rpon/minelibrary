...
export function FavoriteCard(props: FavoriteCardProps) {
  ...
  // 本棚一覧の仮データ（TODO: 実際のデータ取得方法を確認）
  const bookshelves: any[] = []; // TODO: 本棚一覧取得方法を確認
  ...
  const handleCreateBookshelf = async (
    ...
    await bookHook.actions.createBookshelf(bookShelfName, description);
  };
  ...
  return (
    <BaseCard variant="book-favorite" {...props}>
            ...
            <DropdownMenuContent className="w-56">
              {bookshelves.map((shelf) => (
                <DropdownMenuItem
                  ...
                  onClick={() =>
                    bookHook.actions.addToBookshelf(shelf.id, isbn)
                  }
                >
                  <Library className="mr-2 h-4 w-4" />
              ...
              <DropdownMenuItem
                ...
                onClick={bookHook.dialogs.createBookShelf.open}
              >
      ...
      <CreateBookShelfDialog
        isOpen={bookHook.dialogs.createBookShelf.isOpen}
        onClose={bookHook.dialogs.createBookShelf.close}
